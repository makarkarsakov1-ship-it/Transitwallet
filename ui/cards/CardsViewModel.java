...
public class CardsViewModel extends AndroidViewModel {
    ...
    private final MutableLiveData<String> _scanStatus = new MutableLiveData<>();
    public final LiveData<String> scanStatus = _scanStatus;

    // 0=idle, 1=reading, 2=success, 3=error
    private final MutableLiveData<Integer> _scanState = new MutableLiveData<>(0);
