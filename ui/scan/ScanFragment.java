...
public class ScanFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view,
        ...
        viewModel.scanState.observe(getViewLifecycleOwner(), state -> {
            switch (state) {
                case 1:
                    scanStatus.setText(getString(R.string.reading_card));
                    scanStatus.setTextColor(0xFF4A90E2);
                    break;
                case 2:
                    scanStatus.setText(getString(R.string.card_added));
                    scanStatus.setTextColor(0xFF4CAF88);
                    break;
                case 3:
                    scanStatus.setText(getString(R.string.read_error));
                    scanStatus.setTextColor(0xFFF5A623);
                    break;
                default:
                    scanStatus.setText(getString(R.string.scan_prompt));
    ...
    private AnimatorSet makePulse(View v, long delay) {
        ObjectAnimator sx = ObjectAnimator.ofFloat(v,"scaleX",0.8f,1.2f);
        ObjectAnimator sy = ObjectAnimator.ofFloat(v,"scaleY",0.8f,1.2f);
        ObjectAnimator a  = ObjectAnimator.ofFloat(v,"alpha", 0.8f,0f);
