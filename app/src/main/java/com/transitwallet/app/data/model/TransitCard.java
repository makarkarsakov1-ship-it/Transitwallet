...
public class TransitCard {
    ...
    public String cardType;    // TROIKA, STRELKA, EDINIY, UNKNOWN
    ...
    public TransitCard(@NonNull String uid, String cardType, String cardNumber,
                       double balance, int tripsCount, long lastUsed,
